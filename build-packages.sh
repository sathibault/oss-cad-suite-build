...
tar --strip-components=3 -xzf ../../../ext/oss-cad-suite-build/windows-x64-python3.tgz
tar --strip-components=3 -xzf ../../../ext/oss-cad-suite-build/windows-x64-ghdl.tgz
#tar --strip-components=3 -xzf ../../../ext/oss-cad-suite-build/windows-x64-yosys.tgz
#tar --strip-components=3 -xzf ../../../ext/oss-cad-suite-build/windows-x64-icestorm.tgz
#tar --strip-components=3 -xzf ../../../ext/oss-cad-suite-build/windows-x64-nextpnr-ice40.tgz
#tar --strip-components=3 -xzf ../../../ext/oss-cad-suite-build/windows-x64-nextpnr-gowin.tgz
